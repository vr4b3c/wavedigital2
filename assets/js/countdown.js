...
var countdown = (function () {
    ...
    function w(a, b)
    {
        ...
        var c = +a.value || 0;
        if (c) {
            return b.setTime(b.getTime() + c), b;
        }
        ...
        if (0 <= a[e]) {
            ...
            switch (e) {
                ...
                case 'days':
                    ...
                    a.days = 0;
                case 'weeks':
                    if (a.weeks !== v(a.refMonth) / 7 || isNaN(a.months)) {
                        break;
                    }
                    a.months++;
                    a.weeks = 0;
                ...
                case 'years':
                    ...
                    a.years = 0;
                case 'decades':
                    if (10 !== a.decades || isNaN(a.centuries)) {
                        break;
                    }
                    a.centuries++;
                    a.decades = 0;
    ...
    function A(a, b, c, e, l, d)
    {
        ...
        try {
            ...
            for (; 0 > a.days; ) {
                a.months--, (a.days += z(a.refMonth, 1));
            }
