	...
	var makeStriped = function makeStriped(treeview) {
		...
		var uTags = tags.filter(function (tag) {
			...
			while (tag.parentElement) {
				if (
					tag.parentElement.classList.contains(ClassName.COLLAPSE_HIDDEN)
				) {
					result = false;
					break;
				}
				...
				series: [
					...
					},
					{
						...
						data: [
							...
							5155, 5267, 5566, 5689, 5692, 5758, 5773, 5799, 5960, 6000,
						],
						showSymbol: false,
						symbol: 'circle',
						itemStyle: {
				...
				series: [
					{
						...
						name: 'Closed Amount',
						data: [
							0, 5000, 18000, 40000, 58000, 65000, 90000, 110000, 140000,
						],
						symbolSize: 5,
						symbol: 'circle',
						smooth: false,
				...
				series: [
					{
						...
						data: [
							...
							},
							{
								...
								areaStyle: {
									color: [
										utils.rgbaColor(utils.getColors().primary, 0.24),
									],
								},
								symbol: 'circle',
								symbolSize: 8,
